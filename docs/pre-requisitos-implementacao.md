...
- Variaveis de ambiente reais: `DATABASE_URL`, `APP_URL`, `NEXT_PUBLIC_APP_URL`, `AUTH_SECRET`, `PAYMENT_PROVIDER_KEY`, `PAYMENT_PROVIDER_SECRET`, `GMAIL_USER`, `GMAIL_APP_PASSWORD`, `RESEND_API_KEY` (futuro), `STORAGE_BUCKET`.
